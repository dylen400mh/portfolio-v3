...
To mitigate this we chose to build with [Stagehand](https://github.com/browserbase/stagehand), a browser automation framework from Browserbase that lets you describe what you want in plain language instead of hardcoding selectors.
